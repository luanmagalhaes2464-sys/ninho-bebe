...
const PROFILE={mother:'Isabela',city:'Viçosa',state:'MG',plan:'Agros',planHolder:'Isabela',transfer:'2026-07-31',embryoDays:5,birthEstimate:'2027-04-18',sex:'Menino',babyNames:'Ian'};
const LATEST_BABY_MEASUREMENT={date:'2026-09-16',cm:2.6,label:'Medida registrada pela médica'};
...
const defaultItems=[
 ...
 I('rn3','Macacão com pezinho','Roupas','RN',3,'2º trimestre',true,'Três são um meio-termo entre listas enxutas (Huggies) e listas hospitalares maiores. RN costuma durar pouco.','Nascimento'),
 ...
 I('rn5','Casaquinho leve','Roupas','RN',2,'2º trimestre',false,'Dois permitem rodízio e fazem sentido para nascimento em abril/maio, sem grande estoque RN.','Nascimento'),
 I('rn6','Meias','Roupas','RN',4,'2º trimestre',false,'Quatro pares são uma base prática para o início.','Nascimento'),
 ...
 I('p1r','Body manga curta','Roupas','P / 0–3m',3,'2º trimestre',true,'Como maio–julho tende a ser mais fresco em Viçosa, priorizar manga longa nesta fase.','0–3m'),
 I('p2r','Body manga longa','Roupas','P / 0–3m',4,'2º trimestre',true,'Quatro dão boa rotação; comprar mais somente se a rotina real de trocas pedir.','0–3m'),
 ...
 I('s6','Manta / cueiro para colo e passeio','Sono','Único',2,'3º trimestre',true,'Duas peças leves resolvem colo e passeio. Não deixar soltas no berço durante o sono.','Nascimento'),
 I('s9','Cobertor de microfibra','Sono','Único',1,'3º trimestre',true,'Um cobertor mais quente complementa as duas mantas leves para saídas frias. Não deixar solto no berço durante o sono.','Nascimento'),
 ...
 // HIGIENE E TROCAS
 I('h1','Algodão em discos ou bolas','Higiene','Pacote',1,'3º trimestre / repor quando acabar',true,'Começar com um pacote para higiene com água e repor conforme o consumo.','Nascimento'),
 I('h2','Gaze estéril','Higiene','Pacote pequeno',1,'3º trimestre',false,'Um pacote pequeno é suficiente para começar; uso do coto deve seguir a orientação da maternidade/equipe.','Nascimento'),
 ...
 I('h5','Lenço umedecido sem perfume/álcool','Higiene','Pacote',1,'Perto do parto / testar tolerância',false,'Começar com um pacote para testar a pele. Em casa, água e algodão podem ser suficientes no início.','Nascimento'),
 ...
 I('h15','Creme barreira para assadura','Higiene','Tubo',1,'3º trimestre / repor quando acabar',true,'Começar com um tubo; não há necessidade de estoque inicial grande.','Nascimento'),
 I('h16','Cesto de roupas do bebê','Higiene','Único',1,'3º trimestre',false,'Ajuda a separar peças pequenas.','Nascimento'),
 I('h17','Organizador/cesto para trocas','Higiene','Único',1,'3º trimestre',false,'Um cesto funcional já organiza fraldas e higiene; adicionar outros só se a casa pedir.','Nascimento'),
 ...
 I('sa5','Escova dental infantil macia','Saúde','Primeiros dentes',1,'Quando nascer o primeiro dente',true,'Uma escova pequena e macia é suficiente; substituir conforme desgaste.','6–24m','Esperar'),
 I('sa6','Creme dental fluoretado','Saúde','Primeiros dentes',1,'Quando nascer o primeiro dente',true,'Ministério da Saúde orienta creme dental com flúor (>1.100 ppm), em quantidade menor que um grão de arroz.','6–24m','Esperar'),
 ...
 I('ps1','Bebê conforto certificado pelo Inmetro','Passeio','Nascimento',1,'2º trimestre',true,'Para carro desde o nascimento. Conferir registro/selo Inmetro, faixa de peso/altura, instalação e histórico do produto.','Nascimento','Pesquisar'),
 I('ps2','Carrinho registrado no Inmetro e adequado ao RN','Passeio','Único',1,'2º/3º trimestre',true,'Para usar desde o nascimento, precisa permitir posição adequada/reclinada conforme manual e ter registro Inmetro. Comparar também peso e porta-malas.','Nascimento','Pesquisar'),
 ...
 I('al1','Mamadeira pequena (120–160 ml)','Alimentação','0–6m',0,'Somente conforme plano alimentar',false,'Ministério da Saúde não recomenda mamadeira quando o objetivo é aleitamento materno exclusivo. No Ninho: materno 0, misto 3, fórmula 6.','Nascimento','Esperar'),
 I('al2','Mamadeira média/grande (240–330 ml)','Alimentação','6m+',0,'Mais perto do uso',false,'Não comprar agora. Se houver uso de mamadeiras, ajustar perto dos 6 meses: materno 0, misto 2, fórmula 4.','6–12m','Esperar'),
 I('al9','Bicos extras compatíveis','Alimentação','Fluxo adequado',0,'Somente se usar mamadeira',false,'Não comprar antes de saber se haverá uso e qual modelo/fluxo funcionará.','Nascimento','Esperar'),
 I('al10','Escova para mamadeira e bico','Alimentação','Único',1,'Se usar mamadeiras',false,'Uma escova própria é suficiente; substituir quando desgastar.','Nascimento','Pesquisar'),
 ...
 I('al12','Escorredor para mamadeiras','Alimentação','Único',0,'Somente se a rotina com mamadeiras pedir',false,'Conveniente, mas não essencial; pode esperar até saber se haverá uso frequente de mamadeiras.','Nascimento','Esperar'),
 I('al13','Bomba tira-leite','Alimentação','Único',0,'Somente se houver necessidade de extração',false,'Não comprar por obrigação. Avaliar após orientação/necessidade; pode ser comprada ou alugada.','Nascimento','Esperar'),
 I('al14','Potes/sacos para armazenar leite','Alimentação','Unidades',0,'Somente se houver extração',false,'Comprar apenas se a extração realmente entrar na rotina; começar com poucas unidades.','Nascimento','Esperar'),
 I('al15','Absorventes para seios','Alimentação','Caixa/pacote',1,'Perto do parto',false,'Começar com uma embalagem; repor se houver vazamento e uso frequente.','Nascimento'),
 ...
 I('al3','Babadores de alimentação','Alimentação','6m+',5,'5–6 meses',true,'Cinco dão rotação prática para refeições e lavagem; comprar perto da introdução alimentar.','6–12m','Esperar'),
 ...
 I('dev5','Mordedores','Desenvolvimento','3m+',2,'3–4 meses',false,'Dois já permitem rodízio e higiene; comprar mais só se necessário.','3–12m','Esperar'),
 I('dev3','Livros cartonados / resistentes','Desenvolvimento','6m+',3,'Após 5 meses',false,'Três livros já permitem começar; leitura é importante, mas não é necessário comprar seis de uma vez.','6–24m','Esperar'),
...
const motherVaccines=[
 ...
 {id:'mv6',when:'A partir da 28ª semana',name:'VSR · vacina contra bronquiolite na gestação',dose:'1 dose em cada gestação',note:'Protege contra doença por vírus sincicial respiratório, principal causa de bronquiolite, transferindo anticorpos ao bebê nos primeiros meses.'},
...
const RETIRED_DEFAULT_IDS=new Set(['h9','h13','ps5','ps6']);
const FEEDING_TARGETS={
 al1:{'Ainda não definido':0,'Aleitamento materno':0,'Misto':3,'Fórmula':6},
 al2:{'Ainda não definido':0,'Aleitamento materno':0,'Misto':2,'Fórmula':4},
 al9:{'Ainda não definido':0,'Aleitamento materno':0,'Misto':2,'Fórmula':4},
 al10:{'Ainda não definido':0,'Aleitamento materno':0,'Misto':1,'Fórmula':1},
 al11:{'Ainda não definido':0,'Aleitamento materno':0,'Misto':1,'Fórmula':1},
 al12:{'Ainda não definido':0,'Aleitamento materno':0,'Misto':0,'Fórmula':0}
};
...
function renderEnxoval(){
 ...
 const phases=[...new Set(state.items.map(i=>i.phase).filter(Boolean))];
 ...
 const matchesPhase=i=>!currentPhases.length||currentPhases.includes(i.phase);
 const matchesSize=i=>!currentSizes.length||extractSizeTags(i).some(tag=>currentSizes.includes(tag));
 const rows=state.items.filter(i=>(currentCat==='Todos'||i.category===currentCat)&&matchesPhase(i)&&matchesSize(i)&&(currentWhen==='Todos'||i.when===currentWhen)&&matchesCompletion(i));
...
function agentContext(){
 const st=stats();
 return {
  profile:{baby:PROFILE.babyNames,sex:PROFILE.sex,mother:PROFILE.mother,city:PROFILE.city+'/'+PROFILE.state,plan:PROFILE.plan,transfer:PROFILE.transfer,embryoDays:PROFILE.embryoDays,birthEstimate:PROFILE.birthEstimate,weeks,days,daysToDue,latestMeasurement:LATEST_BABY_MEASUREMENT},
...
function agentAnswer(q){const t=q.toLowerCase(),st=stats();
 ...
 if(/semana|gesta|quanto tempo/.test(t))return `Hoje a Isabela está com ${weeks} semanas${days?` e ${days} dias`:''}, calculadas pela transferência de embrião D5 em 31/07/2026. A última medida registrada do Ian foi ${LATEST_BABY_MEASUREMENT.cm.toFixed(1).replace('.',',')} cm em ${fmtDate(LATEST_BABY_MEASUREMENT.date)}.`;
 if(/tamanho.*ian|ian.*tamanho|medid.*ian|quanto.*mede|tamanho.*beb|beb.*tamanho/.test(t))return `A última medida registrada do Ian foi ${LATEST_BABY_MEASUREMENT.cm.toFixed(1).replace('.',',')} cm em ${fmtDate(LATEST_BABY_MEASUREMENT.date)}. As medidas semanais do app são apenas referências aproximadas; a medida registrada pela médica é a informação principal.`;
 ...
 if(/bronquiolite|nirsevimabe|nirsevimab|virus sincicial|vírus sincicial/.test(t))return `A proteção contra bronquiolite por VSR aparece de duas formas: Isabela tem vacina VSR no SUS a partir de 28 semanas; para o bebê, nirsevimabe é um anticorpo monoclonal, não uma vacina. No SUS em 2026 ele é destinado a prematuros menores de 37 semanas e crianças até 24 meses com comorbidades elegíveis. Como Ian nasce em 2027, precisamos revalidar perto do parto.`;
 if(/primeira.*vacina|vacina.*bebê|vacina.*bebe|bcg/.test(t))return `Ao nascer, o PNI prevê hepatite B e BCG. O calendário SUS é gratuito. Além dele, a SBIm recomenda diferenças no privado, como meningocócica B e ACWY mais ampla no primeiro ano; outras opções privadas, como hexavalente e rotavírus pentavalente, são alternativas ao esquema público. Como Ian nascerá em 2027, o calendário deve ser revalidado perto do nascimento.`;
