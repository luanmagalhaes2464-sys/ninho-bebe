...
function renderEnxoval(){
 ...
 <div class="notice inventory-note"><b>Alvo = quantidade de rotina para a fase, não mínimo.</b> Vocês não precisam comprar tudo agora; itens futuros continuam marcados como “Esperar”. Para fraldas, o alvo é por pacotes médios e deve ser ajustado ao peso e à marca. <b>Roupas agora são ajustadas pela época do ano em Viçosa e pela idade prevista do bebê.</b> Use <b>Itens → Pendentes</b> para esconder o que já atingiu a quantidade-alvo. Em <b>Fase</b> e <b>Tamanho/faixa</b>, marque várias opções juntas — por exemplo, RN + 0–3m.</div>${renderSeasonPlanner()}
