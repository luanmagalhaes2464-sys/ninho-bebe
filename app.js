...
const defaultItems=[
 ...
 I('d2','Fralda descartável','Fraldas','P · pacote',16,'Chá / perto do parto',true,'Meta sincronizada com o Chá. Planejamento conservador: até 10 fraldas/dia; ajuste depois pelo peso e consumo real.','0–4m'),
 I('d3','Fralda descartável','Fraldas','M · pacote',25,'Chá / após nascer',true,'Meta sincronizada com o Chá. Planejamento conservador: até 8 fraldas/dia nesta fase.','5–10m','Esperar'),
 I('d4','Fralda descartável','Fraldas','G · pacote',26,'Chá / após nascer',true,'Meta sincronizada com o Chá. Planejamento: cerca de 5 fraldas/dia e fase longa.','11–20m','Esperar'),
 I('d5','Fralda descartável','Fraldas','XG · pacote',8,'Chá / após nascer',true,'Meta sincronizada com o Chá. Planejamento: cerca de 4 fraldas/dia; início depende do peso e da modelagem.','21–24m','Esperar'),
...
const babyVaccines=[
 ...
 {id:'bv3',age:'2 meses',name:'Pentavalente',dose:'1ª dose'}, {id:'bv4',age:'2 meses',name:'Poliomielite inativada (VIP)',dose:'1ª dose'}, {id:'bv5',age:'2 meses',name:'Rotavírus',dose:'1ª dose'}, {id:'bv6',age:'2 meses',name:'Pneumocócica conjugada',dose:'1ª dose'},
 {id:'bv7',age:'3 meses',name:'Meningocócica C',dose:'1ª dose'},
 {id:'bv8',age:'4 meses',name:'Pentavalente',dose:'2ª dose'}, {id:'bv9',age:'4 meses',name:'Poliomielite inativada (VIP)',dose:'2ª dose'}, {id:'bv10',age:'4 meses',name:'Rotavírus',dose:'2ª dose'}, {id:'bv11',age:'4 meses',name:'Pneumocócica conjugada',dose:'2ª dose'},
 {id:'bv12',age:'5 meses',name:'Meningocócica C',dose:'2ª dose'},
 {id:'bv13',age:'6 meses',name:'Pentavalente',dose:'3ª dose'}, {id:'bv14',age:'6 meses',name:'Poliomielite inativada (VIP)',dose:'3ª dose'}, {id:'bv15',age:'6 meses',name:'Influenza',dose:'Início da vacinação anual'}, {id:'bv16',age:'6 meses',name:'Covid-19',dose:'1ª dose conforme produto/esquema vigente'},
 {id:'bv17',age:'7 meses',name:'Covid-19',dose:'2ª dose conforme produto/esquema vigente'},
 ...
 {id:'bv20',age:'12 meses',name:'Pneumocócica conjugada',dose:'Reforço'}, {id:'bv21',age:'12 meses',name:'Meningocócica ACWY',dose:'1 dose'}, {id:'bv22',age:'12 meses',name:'Tríplice viral (SCR)',dose:'1ª dose'},
...
const DIAPER_REF=[
 ...
 {size:'P',age:'aprox. 2–4 meses',daily:'10/dia',monthly:'~300/mês',share:.20,note:'Meta conservadora do Ninho; referências de marcas costumam ficar em ~6–8/dia.'},
 {size:'M',age:'aprox. 5–10 meses',daily:'8/dia',monthly:'~240/mês',share:.31,note:'Meta conservadora; Huggies/Pampers publicam faixas em torno de 5–8/dia.'},
 {size:'G',age:'aprox. 11–20 meses',daily:'5/dia',monthly:'~150/mês',share:.33,note:'Alinhado às referências de marcas e com fase geralmente longa.'},
 {size:'XG',age:'aprox. 20–24 meses',daily:'4/dia',monthly:'~120/mês',share:.10,note:'Pode começar antes/depois conforme peso, corpo e modelagem da marca.'}
];
const DIAPER_ITEM_SIZE={d1:'RN',d2:'P',d3:'M',d4:'G',d5:'XG'};
const VACCINE_PRIVATE_INFO={
 mv1:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Sob consulta'},
 mv2:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Sob consulta'},
 mv3:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 99,75 · gripe tetravalente'},
 mv4:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Disponibilidade varia'},
 mv5:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 228,00 · dTpa'},
 mv6:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 1.743,00 · Abrysvo'},
 mv7:{sus:'Sim, se indicada · R$ 0',agros:'Confirmar no plano',price:'R$ 174,81'},
 bv1:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Sob consulta'},
 bv2:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Geralmente feita no SUS'},
 bv3:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 304,95 · penta acelular'},
 bv4:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Combinações privadas disponíveis'},
 bv5:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Pentavalente privada disponível'},
 bv6:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 527,00 · pneumo 20 (ref.)'},
 bv7:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 380,95 · ACWY (alternativa privada)'},
 bv8:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 304,95 · penta acelular'},
 bv9:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Combinações privadas disponíveis'},
 bv10:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Pentavalente privada disponível'},
 bv11:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 527,00 · pneumo 20 (ref.)'},
 bv12:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 380,95 · ACWY (alternativa privada)'},
 bv13:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 304,95 · penta acelular'},
 bv14:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Combinações privadas disponíveis'},
 bv15:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 99,75 · gripe tetravalente'},
 bv16:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Disponibilidade varia'},
 bv17:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Disponibilidade varia'},
 bv18:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Disponibilidade varia'},
 bv19:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 174,81'},
 bv20:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 527,00 · pneumo 20 (ref.)'},
 bv21:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 380,95 · ACWY'},
 bv22:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Sob consulta'},
 bv23:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Combinações privadas disponíveis'},
 bv24:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Combinações privadas disponíveis'},
 bv25:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Sob consulta'},
 bv26:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'Sob consulta'},
 bv27:{sus:'Sim · R$ 0',agros:'Confirmar no plano',price:'R$ 157–193 · ref. privada'},
 bv28:{sus:'Revisão no SUS · R$ 0',agros:'Confirmar no plano',price:'—'},
 bv29:{sus:'Revisão no SUS · R$ 0',agros:'Confirmar no plano',price:'—'}
};
const PRIVATE_VAX_EXTRA=[
 {name:'Meningocócica B',when:'A partir de 3 meses (SBIm)',sus:'Não no PNI de rotina',price:'R$ 643,15/dose',note:'SBIm 2026/2027 recomenda no calendário infantil privado.'},
 {name:'Hexavalente acelular',when:'2, 4 e 6 meses (conforme esquema)',sus:'Não como hexavalente de rotina',price:'R$ 298–322/dose',note:'Combina DTPa + Hib + hepatite B + VIP.'},
 {name:'Rotavírus pentavalente',when:'Esquema privado',sus:'PNI oferece rotavírus monovalente',price:'Preço varia',note:'SBIm informa a opção pentavalente em serviços privados.'},
 {name:'Pneumocócica 20-valente',when:'Esquema infantil',sus:'PNI 2026 está em transição VPC20/VPC10',price:'~R$ 527/dose',note:'A disponibilidade no SUS depende da estratégia vigente/local.'}
];
...
function targetFor(i){if(DIAPER_ITEM_SIZE[i.id])return diaperPlan()[DIAPER_ITEM_SIZE[i.id]]||0;return FEEDING_TARGETS[i.id]?.[state.feedingMode] ?? Number(i.recommended||0)}
...
function diaperPlan(){const n=Math.max(0,+state.showerGuests||0);const vals={};let used=0;DIAPER_REF.forEach((r,idx)=>{if(idx===DIAPER_REF.length-1)vals[r.size]=Math.max(0,n-used);else{vals[r.size]=Math.round(n*r.share);used+=vals[r.size]}});return vals}
function renderTea(){const p=diaperPlan();$('#view-cha').innerHTML=`<div class="grid-2"><div class="card panel"><div class="section-head"><div><h2>Planejador do chá de fraldas</h2><p>Planejamento conservador com margem de segurança, calibrado a partir de referências Huggies/Pampers e da preferência de vocês.</p></div></div><div class="field"><label>Número estimado de convidados/presentes</label><input type="number" min="0" value="${state.showerGuests}" onchange="setGuests(this.value)"></div><div class="diaper-plan diaper-plan-5" style="margin-top:16px">${DIAPER_REF.map(r=>`<div class="diaper"><span>Tamanho</span><b>${r.size}</b><span>${p[r.size]} pacotes/presentes</span><small>${r.age} · ${r.daily}</small></div>`).join('')}</div><div class="notice" style="margin-top:14px"><b>Importante:</b> pacote não é uma unidade padrão — cada marca/tamanho traz quantidades diferentes. Use esta divisão para orientar o chá e, depois, ajuste pelo peso, adaptação à marca e ritmo real de trocas.</div></div><div class="card panel"><div class="section-head"><div><h2>Consumo usado no planejamento</h2><p>P e M usam uma margem acima da média publicada; G e XG ficam próximos às referências de mercado.</p></div></div><div class="diaper-reference">${DIAPER_REF.map(r=>`<div class="diaper-ref-row"><b>${r.size}</b><div><span>${r.age}</span><small>${r.monthly} · ${r.note}</small></div></div>`).join('')}</div><div class="notice" style="margin-top:14px"><b>Por que P=10 e M=8?</b> É uma margem de planejamento para não faltar. Huggies publica P em torno de 6–8/dia e M em torno de 5–8/dia; Pampers também mostra maior consumo nas fases iniciais. O estoque real deve ser corrigido depois pelo peso e pelo ritmo do bebê.</div><div class="contact-actions" style="margin-top:10px"><a class="btn soft" target="_blank" href="https://www.huggies.com.br/artigos/cha-de-bebe/como-organizar/lista-de-cha-de-bebe-o-que-pedir">Huggies · chá</a><a class="btn soft" target="_blank" href="https://www.pampers.com.br/cha-de-fraldas/temas-e-decoracao/artigo/como-organizar-a-lista-de-fraldas-para-o-cha-de-fraldas">Pampers · chá</a></div></div></div>`}
...
function renderMotherVax(){const done=motherVaccines.filter(v=>state.motherVax[v.id]?.done).length;$('#view-vacmae').innerHTML=`<div class="grid-2"><div class="card panel"><div class="section-head"><div><h2>Carteira da Isabela</h2><p>${done} de ${motherVaccines.length} registros marcados.</p></div></div><div class="vax-progress"><span style="width:${Math.round(done/motherVaccines.length*100)}%"></span></div><div class="notice" style="margin-top:14px"><b>SUS:</b> as vacinas listadas no calendário da gestante estão disponíveis gratuitamente conforme indicação do PNI 2026. <b>Agros:</b> como o plano comercial exato da Isabela não foi informado e o Agros remete as coberturas adicionais ao regulamento de cada produto, o Ninho marca “Confirmar no plano” em vez de presumir cobertura. Preços particulares são referências atuais e podem mudar.</div></div><div class="card panel baby-note"><div class="baby-note-icon">${icons.syringe}</div><h2>Próximo marco</h2><p>${weeks<20?`dTpa a partir da 20ª semana — faltam aproximadamente ${20-weeks} semanas.`:weeks<28?'dTpa já está na janela indicada; confirme com o pré-natal.':'dTpa e VSR já estão em janela gestacional; confirme o registro com a equipe.'}</p></div></div><div class="card panel" style="margin-top:16px"><div class="vax-list">${motherVaccines.map(v=>vaxRow(v,'motherVax')).join('')}</div><div class="source"><b>Fonte oficial</b><p>Calendário Nacional de Vacinação — Gestante, Ministério da Saúde, atualizado em 2026.</p><a target="_blank" href="https://www.gov.br/saude/pt-br/vacinacao/calendario">Abrir calendário</a></div></div>`}
function renderBabyVax(){const done=babyVaccines.filter(v=>state.babyVax[v.id]?.done).length;const grouped=[...new Set(babyVaccines.map(v=>v.age))];$('#view-vacbebe').innerHTML=`<div class="grid-2"><div class="card panel"><div class="section-head"><div><h2>Vacinação de Ian ou Luísa</h2><p>Do nascimento até 24 meses.</p></div></div><div class="vax-progress"><span style="width:${Math.round(done/babyVaccines.length*100)}%"></span></div><div class="notice" style="margin-top:14px">O bebê deve nascer em 2027. Esta guia usa o PNI 2026 como base e deve ser revalidada após o nascimento. As vacinas do PNI são gratuitas no SUS; a cobertura privada do Agros precisa ser conferida conforme o produto da Isabela.</div></div><div class="card panel"><div class="baby-card-illustration">${icons.shield}<span>vacinas do<br><b>Ian ou Luísa</b></span></div><p class="body-copy">Ao nascer: hepatite B e BCG. Depois, o app organiza as próximas doses por idade e permite registrar data, local e observações.</p></div></div><div class="vax-groups">${grouped.map(age=>`<div class="card panel"><div class="section-head"><div><h2>${age}</h2><p>${babyVaccines.filter(v=>v.age===age).length} item(ns)</p></div></div>${babyVaccines.filter(v=>v.age===age).map(v=>vaxRow(v,'babyVax')).join('')}</div>`).join('')}</div><div class="card panel" style="margin-top:16px"><div class="section-head"><div><h2>Opções adicionais/alternativas privadas</h2><p>Referência SBIm 2026/2027. Não significa que sejam obrigatórias para todo bebê.</p></div></div><div class="private-vax-grid">${PRIVATE_VAX_EXTRA.map(v=>`<div class="private-vax-card"><b>${v.name}</b><span>${v.when}</span><small>SUS: ${v.sus}</small><strong>${v.price}</strong><p>${v.note}</p></div>`).join('')}</div><div class="source"><b>Fontes</b><p>PNI 2026 (Ministério da Saúde) + Calendário SBIm 2026/2027. Preços particulares: referências públicas recentes do Hermes Pardini/Sabin.</p><a target="_blank" href="https://www.gov.br/saude/pt-br/vacinacao/calendario">PNI</a> · <a target="_blank" href="https://sbim.org.br/calendarios-de-vacinacao">SBIm</a></div></div>`}
function vaxRow(v,key){const r=state[key][v.id]||{},info=VACCINE_PRIVATE_INFO[v.id]||{sus:'Consultar',agros:'Confirmar no plano',price:'Sob consulta'};return `<div class="vax-row ${r.done?'done':''}"><button class="vax-toggle" onclick="toggleVax('${key}','${v.id}')">${r.done?'✓':''}</button><div class="vax-main"><b>${v.name}</b><span>${v.when||v.age} · ${v.dose}</span>${v.note?`<small>${v.note}</small>`:''}<div class="coverage-row"><span class="coverage-pill sus">SUS · ${info.sus}</span><span class="coverage-pill agros">Agros · ${info.agros}</span><span class="coverage-pill price">Particular · ${info.price}</span></div>${r.date||r.place||r.note?`<div class="vax-meta">${r.date?`<span>📅 ${fmtDate(r.date)}</span>`:''}${r.place?`<span>📍 ${esc(r.place)}</span>`:''}${r.note?`<span>📝 ${esc(r.note)}</span>`:''}</div>`:''}</div><button class="btn tiny" onclick="editVax('${key}','${v.id}')">Registrar</button></div>`}
