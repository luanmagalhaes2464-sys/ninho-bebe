...
function agentAnswer(q){const t=q.toLowerCase(),st=stats();
 ...
 if(/bronquiolite|nirsevimabe|nirsevimab|virus sincicial|vírus sincicial/.test(t))return `A proteção contra bronquiolite por VSR aparece de duas formas: Isabela tem vacina VSR no SUS a partir de 28 semanas; para o bebê, nirsevimabe é um anticorpo monoclonal, não uma vacina. No SUS em 2026 ele é destinado a prematuros menores de 37 semanas e crianças até 24 meses com comorbidades elegíveis. Como Ian/Luísa nasce em 2027, precisamos revalidar perto do parto.`;
